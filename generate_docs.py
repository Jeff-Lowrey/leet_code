...
CATEGORIES = {
    ...
    'binary-search': {
        ...
        'patterns': ['Classic Binary Search', 'Search in Rotated Array', 'Binary Search on Answer', 'Search in 2D Matrix'],
...
def create_category_readme(category_key, category_info):
...
def create_problem_doc(problem_num, problem_name, category):
