...
class TestExecuteSearch:
    ...
    def test_navigate_mode_found(self):
    ...
    def test_navigate_mode_not_found(self):
    ...
    def test_similar_mode_found(self):
    ...
    def test_similar_mode_reference_not_found(self):
    ...
    def test_name_search_mode(self):
