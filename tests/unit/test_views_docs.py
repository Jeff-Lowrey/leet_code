...
class TestDocsIndexView:
    ...
    def test_get_success(self, mock_path: MagicMock, client: Any) -> None:
        ...
        mock_docs_path.iterdir.return_value = [mock_category_dir]
        mock_path.return_value.parent.parent.parent.parent.__truediv__.return_value = mock_docs_path

        response = client.get("/docs")
        assert response.status_code == 200

    @patch("src.leet_code.views.docs_views.Path")
    def test_get_no_docs_directory(self, mock_path: MagicMock, client: Any) -> None:
    ...
    @patch("src.leet_code.views.docs_views.Path")
    def test_get_special_categories(self, mock_path: MagicMock, client: Any) -> None:
        ...
        mock_docs_path.iterdir.return_value = sorted(mock_category_dirs, key=lambda x: x.name)
        mock_path.return_value.parent.parent.parent.parent.__truediv__.return_value = mock_docs_path
...
class TestDocsReadmeView:
    ...
    def test_get_success(self, mock_path: MagicMock, client: Any) -> None:
        ...
        mock_path.return_value.parent.parent.parent.parent.__truediv__.return_value.__truediv__.return_value = (
            mock_readme
        )
    ...
    @patch("src.leet_code.views.docs_views.Path")
    def test_get_not_found(self, mock_path: MagicMock, client: Any) -> None:
...
class TestDocsView:
    ...
    @patch("src.leet_code.views.docs_views.Path")
    def test_get_category_readme(self, mock_path: MagicMock, client: Any) -> None:
        ...
        mock_path.return_value.parent.parent.parent.parent.__truediv__.return_value.__truediv__.return_value.__truediv__.return_value = mock_doc_path

        response = client.get("/docs/user-guide")
        assert response.status_code == 200

    @patch("src.leet_code.views.docs_views.Path")
    def test_get_sub_page(self, mock_path: MagicMock, client: Any) -> None:
    ...
    @patch("src.leet_code.views.docs_views.Path")
    def test_get_sub_page_with_md_extension(self, mock_path: MagicMock, client: Any) -> None:
    ...
    @patch("src.leet_code.views.docs_views.Path")
    def test_get_page_not_found(self, mock_path: MagicMock, client: Any) -> None:
