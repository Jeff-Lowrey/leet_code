...
class TestParseSearchQuery:
    ...
    def test_similar_mode_multiple_filters(self) -> None:
    ...
    def test_name_search_single_word(self) -> None:
    ...
    def test_name_search_multiple_words(self) -> None:
    ...
    def test_filter_mode_single_filter(self) -> None:
    ...
    def test_filter_mode_category_filter(self) -> None:
    ...
    def test_case_insensitive_difficulty(self) -> None:
    ...
    def test_filter_with_spaces_in_value(self) -> None:
