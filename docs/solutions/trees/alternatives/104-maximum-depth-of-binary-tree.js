...
function testSolution() {
    ...
    console.assert(result8 === expected1, `Iterative DFS test failed: expected ${expected1}, got ${result8}`);

    const result9 = maxDepthPreorder(tree1);
    console.assert(result9 === expected1, `Preorder test failed: expected ${expected1}, got ${result9}`);
