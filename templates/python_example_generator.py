...
class ExampleGenerator:
    ...
    def generate_array_examples(self, config: ProblemConfig, count: int) -> List[Dict[str, Any]]:
        ...
        examples.extend(
            [
                {"name": "Edge Case - Empty Array", "input": [], "description": "Empty array test"},
                {"name": "Edge Case - Single Element", "input": [42], "description": "Array with single element"},
                {
    ...
    def generate_string_examples(self, config: ProblemConfig, count: int) -> List[Dict[str, Any]]:
        ...
        examples.extend(
            [
                {"name": "Basic Example - Simple String", "input": "hello", "description": "Basic string case"},
                {
        ...
        examples.extend(
            [
                {"name": "Edge Case - Empty String", "input": "", "description": "Empty string test"},
                {"name": "Edge Case - Single Character", "input": "a", "description": "Single character string"},
                {
        ...
        examples.extend(
            [
                {"name": "Pattern Case - Palindrome", "input": "racecar", "description": "Palindromic string"},
                {
    ...
    def generate_tree_examples(self, config: ProblemConfig, count: int) -> List[Dict[str, Any]]:
        ...
        examples.extend(
            [
                ...
                {"name": "Basic Tree - Simple", "input": [1, 2, 3], "description": "Simple three-node tree"},
                {"name": "Edge Case - Single Node", "input": [1], "description": "Tree with only root node"},
                {"name": "Edge Case - Empty Tree", "input": None, "description": "Empty tree (null root)"},
                {
    ...
    def generate_linked_list_examples(self, config: ProblemConfig, count: int) -> List[Dict[str, Any]]:
        ...
        examples.extend(
            [
                ...
                {"name": "Basic List - Small", "input": [1, 2], "description": "Small two-node list"},
                {"name": "Edge Case - Single Node", "input": [1], "description": "Single node list"},
                {"name": "Edge Case - Empty List", "input": None, "description": "Empty linked list"},
                {
    ...
    def generate_number_examples(self, config: ProblemConfig, count: int) -> List[Dict[str, Any]]:
        ...
        examples.extend(
            [
                {"name": "Basic Number - Positive", "input": 42, "description": "Standard positive number"},
                {"name": "Basic Number - Negative", "input": -17, "description": "Negative number test"},
                {"name": "Edge Case - Zero", "input": 0, "description": "Zero value test"},
                {"name": "Edge Case - One", "input": 1, "description": "Unity value test"},
                {"name": "Boundary Case - Large Positive", "input": 2**31 - 1, "description": "Maximum 32-bit integer"},
                {"name": "Boundary Case - Large Negative", "input": -(2**31), "description": "Minimum 32-bit integer"},
            ]
        )
...
def generate_test_cases_for_problem(
    problem_type: str, constraints: Dict[str, Any] = None, count: int = 10
) -> List[Dict[str, Any]]:
    """
    ...
    config = ProblemConfig(
        problem_type=problem_type, input_types=["auto"], constraints=constraints or {}, special_cases=[]
    )
