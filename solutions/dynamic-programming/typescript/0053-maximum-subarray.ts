...
function runTests(): void {
  ...
  console.log(`Test 1: ${solution.maxSubArray([-2, 1, -3, 4, -1, 2, 1, -5, 4]) === 6 ? "PASS" : "FAIL"}`);
  console.log(`Test 2: ${solution.maxSubArray([1]) === 1 ? "PASS" : "FAIL"}`);
  console.log(`Test 3: ${solution.maxSubArray([5, 4, -1, 7, 8]) === 23 ? "PASS" : "FAIL"}`);
