...
function runTests() {
  ...
  console.log(`Test 1: ${JSON.stringify(s1) === JSON.stringify(["o", "l", "l", "e", "h"]) ? "PASS" : "FAIL"}`);

  // Test case 2
  const s2 = ["H", "a", "n", "n", "a", "h"];
  solution.reverseString(s2);
  console.log(`Test 2: ${JSON.stringify(s2) === JSON.stringify(["h", "a", "n", "n", "a", "H"]) ? "PASS" : "FAIL"}`);
  ...
  console.log(`Test 5 (Iterative): ${JSON.stringify(s5) === JSON.stringify(["t", "s", "e", "t"]) ? "PASS" : "FAIL"}`);
