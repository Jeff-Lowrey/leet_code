...
/**
 * Main solution for Problem 380: Insert Delete Getrandom
 *
...
/**
 * Test cases for Problem 380: Insert Delete Getrandom
 */
function testSolution() {
    console.log('Testing 380. Insert Delete Getrandom');
    ...
    console.log('All test cases passed for 380. Insert Delete Getrandom!');
}
...
function demonstrateSolution() {
    console.log('\n=== Problem 380. Insert Delete Getrandom ===');
    console.log('Category: Design');
    console.log('Difficulty: Array');
    console.log('');
