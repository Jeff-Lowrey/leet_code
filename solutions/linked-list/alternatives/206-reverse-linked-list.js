...
function testSolution() {
  ...
  console.assert(
    JSON.stringify(actual3) === JSON.stringify(expected3),
  ...
  console.assert(
    JSON.stringify(actual7) === JSON.stringify(expected7),
  ...
  console.assert(
    JSON.stringify(actual8) === JSON.stringify(expected8),
  ...
  console.assert(
    JSON.stringify(longActual) === JSON.stringify(longExpected),
