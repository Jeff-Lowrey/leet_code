...
function testSolution() {
  ...
  console.assert(
    JSON.stringify(nums1) === JSON.stringify(expected1),
  ...
  console.assert(
    JSON.stringify(nums2) === JSON.stringify(expected2),
  ...
  console.assert(
    JSON.stringify(nums3) === JSON.stringify(expected3),
  ...
  console.assert(
    JSON.stringify(nums4) === JSON.stringify(expected4),
  ...
  console.assert(
    JSON.stringify(nums5) === JSON.stringify(expected5),
