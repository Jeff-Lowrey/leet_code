...
function runTests(): void {
  ...
  console.log(`Test 1: ${solution.firstBadVersion(5) === 4 ? "PASS" : "FAIL"}`);
  console.log(`Test 2: ${solution.firstBadVersion(1) === 1 ? "PASS" : "FAIL"}`);
  console.log(`Test 3: ${solution.firstBadVersion(10) === 4 ? "PASS" : "FAIL"}`);
