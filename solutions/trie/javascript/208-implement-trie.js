...
function testSolution() {
  ...
  trie1.insert("apple");
  console.assert(
    trie1.search("apple") === true,
    'Test 1a failed: should find "apple"',
  );
  console.assert(
    trie1.search("app") === false,
    'Test 1b failed: "app" is not a complete word',
  );
  console.assert(
    trie1.startsWith("app") === true,
    'Test 1c failed: should find prefix "app"',
  );
  trie1.insert("app");
  console.assert(
    trie1.search("app") === true,
    'Test 1d failed: should find "app" after insertion',
  );
