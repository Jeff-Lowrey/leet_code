...
class Solution {
   ...
   * @param {number} left - Start of range (inclusive)
   * @param {number} right - End of range (inclusive)
   * @return {number} - Bitwise AND of all numbers in range [left, right]
   *
   ...
   */
  rangeBitwiseAndBrute(left, right) {
    let result = left;
