 ...
 * ### METADATA:
 * **Techniques**: Two Pointers, Window Technique
 * **Data Structures**: Array
 * **Patterns**: Two Pointer Pattern, Opposite Direction/Same Direction
 * **Time Complexity**: **O(n)
 * **Space Complexity**: **O(1)

 *
 * ### INTUITION:
 * This problem uses two pointers moving through the data structure to achieve linear time complexity.
 *
 * ### APPROACH:
...
function testSolution() {
  ...
  console.assert(
    nums1_1.toString() === expected1.toString(),
    `Test 1 failed: expected ${expected1}, got ${nums1_1}`,
  );
  console.log(
    `Test 1 passed: merge([1,2,3,0,0,0], 3, [2,5,6], 3) = [${nums1_1}]`,
  );
  ...
  const expected2 = [1];
  console.assert(
    nums1_2.toString() === expected2.toString(),
  ...
  const expected3 = [1];
  console.assert(
    nums1_3.toString() === expected3.toString(),
  ...
  console.assert(
    nums1_4.toString() === expected4.toString(),
    `Test 4 failed: expected ${expected4}, got ${nums1_4}`,
  );
  console.log(
    `Test 4 passed: merge([4,5,6,0,0,0], 3, [1,2,3], 3) = [${nums1_4}]`,
  );
  ...
  console.assert(
    nums1_5.toString() === expected5.toString(),
    `Test 5 failed: expected ${expected5}, got ${nums1_5}`,
  );
  console.log(
    `Test 5 passed: merge([1,2,3,0,0,0], 3, [4,5,6], 3) = [${nums1_5}]`,
  );
  ...
  console.assert(
    nums1_6.toString() === expected6.toString(),
    `Test 6 failed: expected ${expected6}, got ${nums1_6}`,
  );
  console.log(
    `Test 6 passed: merge([1,3,5,0,0,0], 3, [2,4,6], 3) = [${nums1_6}]`,
  );
