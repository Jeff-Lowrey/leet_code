...
function testSolution() {
  ...
  console.assert(
    solve(board1, "ABCCED") === true,
    "Test 1 failed: ABCCED should exist",
  );
  console.assert(
    solve(board1, "SEE") === true,
    "Test 2 failed: SEE should exist",
  );
  console.assert(
    solve(board1, "ABCB") === false,
    "Test 3 failed: ABCB should not exist",
  );
  ...
  console.assert(
    solve(board2, "AB") === false,
    "Test 5 failed: AB should not exist",
  );
  ...
  console.assert(
    solve(board3, "ABDC") === true,
    "Test 6 failed: ABDC should exist",
  );
  console.assert(
    solve(board3, "ACDB") === true,
    "Test 7 failed: ACDB should exist",
  );
  ...
  console.assert(
    solve(board4, "ABCESEEEFS") === true,
    "Test 8 failed: ABCESEEEFS should exist",
  );
  ...
  console.assert(
    solve(board5, "AAAAAAAAAAAAA") === false,
    "Test 9 failed: word too long",
  );
  console.assert(
    solve(board5, "AAAA") === true,
    "Test 10 failed: AAAA should exist",
  );
