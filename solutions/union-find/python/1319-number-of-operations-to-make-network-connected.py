...
1. Check cables: 4 cables ≥ n-1 (3) ✓
2. Union (0,1): Connect computers 0 and 1
3. Union (0,2): Connect computer 2 to group {0,1}
4. Union (1,2): Already connected (redundant cable)
5. Union (1,3): Connect computer 3 to group {0,1,2}
6. Count components: 1 (all connected)
...
- **Exact minimum cables**: n=5, connections 4 cables forming tree → return 0
- **Extra redundant cables**: Multiple cables within same component can be reused
- **All computers isolated**: n=5, connections=[] → return -1
